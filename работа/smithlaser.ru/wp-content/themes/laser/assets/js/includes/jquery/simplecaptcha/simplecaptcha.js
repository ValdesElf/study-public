;(function($) {
  ...
  $.extend($.jk.SimpleCaptcha.prototype, {
    ...
    scriptPath:		'http://lasercut.ru/includes/jquery/simplecaptcha/simplecaptcha.php',  // String Relative path to the script file to use (usually simpleCaptcha.php).
    ...
    refreshButton:	"<img src='http://lasercut.ru/includes/jquery/simplecaptcha/refresh.png' class='refreshButton' alt='Обновить' title='Обновить капчу' />",
    ...
    inputName:		'code',    // String Name to use for the captcha hidden input, this is what you will need to check on the receiving end of the form submission.
